    ...
    <div style={styles.page}>
        ...
        <div style={styles.heroInner}>
          <div style={styles.heroLeft}>
            ...
            <p style={styles.heroP}>
              Ai Farm brings real-time AI crop detection, soil health monitoring, and harvest intelligence to farms across Malaysia — all in one platform.
            </p>
      ...
      <footer id="about" style={styles.footer}>
        ...
        <div style={styles.footerBottom}>
          <p style={styles.footerCredit}>© 2026 Ai Farm · Kota Kinabalu, Sabah · All rights reserved</p>
...
const styles = {
  ...
  footer:       { background: "#141710", padding: "4rem 2rem 2rem" },
  ...
  footerCredit: { fontSize: "0.75rem", color: "#3a3d30", fontFamily: "'Segoe UI', sans-serif", margin: 0 },
};